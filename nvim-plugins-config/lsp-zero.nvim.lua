...
local legend = {
	keymaps = {
		...
		{'<leader>qq', vim.diagnostic.set_qflist,   mode={'n'}, description = "Lsp send diagnostics to quickfix"},
		{'<leader>ql', vim.diagnostic.setloclist,   mode={'n'}, description = "Lsp send diagnostics to loclist"},
